 ...
 * Article
 *
 * @ORM\Table(name="article", indexes={@ORM\Index(name="article_utilisateur_FK", columns={"id_utilisateur"}), @ORM\Index(name="article_sous_categorie0_FK", columns={"id_sous_categorie"})})
